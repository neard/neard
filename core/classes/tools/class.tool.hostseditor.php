...
class ToolHostsEditor
{
    const ROOT_CFG_VERSION = 'hostseditorVersion';
    
    const LOCAL_CFG_EXE = 'hostseditorExe';
    ...
    public function __construct($rootPath)
    {
        ...
        $this->name = $neardLang->getValue(Lang::HOSTSEDITOR);
        $this->version = $neardConfig->getRaw(self::ROOT_CFG_VERSION);
        
        $this->rootPath = $rootPath;
        $this->currentPath = $rootPath . '/hostseditor' . $this->version;
