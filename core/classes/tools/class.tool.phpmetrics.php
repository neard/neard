...
class ToolPhpMetrics
{
    const ROOT_CFG_VERSION = 'phpmetricsVersion';
    
    const LOCAL_CFG_EXE = 'phpmetricsExe';
    ...
    public function __construct($rootPath)
    {
        ...
        $this->name = $neardLang->getValue(Lang::PHPMETRICS);
        $this->version = $neardConfig->getRaw(self::ROOT_CFG_VERSION);
        
        $this->rootPath = $rootPath;
        $this->currentPath = $rootPath . '/phpmetrics' . $this->version;
