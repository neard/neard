...
class ToolSetenv
{
    const ROOT_CFG_VERSION = 'setenvVersion';
    
    const LOCAL_CFG_EXE = 'setenvExe';
    ...
    public function __construct($rootPath)
    {
        ...
        $this->name = $neardLang->getValue(Lang::SETENV);
        $this->version = $neardConfig->getRaw(self::ROOT_CFG_VERSION);
        
        $this->rootPath = $rootPath;
        $this->currentPath = $rootPath . '/setenv' . $this->version;
