...
class ToolPhpUnit
{
    const ROOT_CFG_VERSION = 'phpunitVersion';
    
    const LOCAL_CFG_EXE = 'phpunitExe';
    ...
    public function __construct($rootPath)
    {
        ...
        $this->name = $neardLang->getValue(Lang::PHPUNIT);
        $this->version = $neardConfig->getRaw(self::ROOT_CFG_VERSION);
        
        $this->rootPath = $rootPath;
        $this->currentPath = $rootPath . '/phpunit' . $this->version;
