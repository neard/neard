    ...
    <div style="min-height:250px;" class="panel panel-primary">
      ...
      <div class="panel-body panel-summary">
        <div class="list-group" style="margin-bottom:0;">
          ...
          <span class="list-group-item">
            <a href="<?php echo Util::getWebsiteUrl('modules/imagemagick', '#releases'); ?>" target="_blank" title="<?php echo $neardLang->getValue(Lang::DOWNLOAD_MORE); ?>"><span style="float:right;margin-left:8px;"><i class="fa fa-download"></i></span></a>
