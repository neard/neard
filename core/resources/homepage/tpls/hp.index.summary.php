  ...
  <div class="col-lg-4">
    <div class="list-group">
      <div class="list-group-item" style="min-height:150px">
        ...
        <p class="list-group-item-text"><?php echo sprintf($neardLang->getValue(Lang::HOMEPAGE_ABOUT_HTML), Util::getGithubUrl(), Util::getGithubUrl(), Util::getGithubUrl(), Util::getGithubUrl(), Util::getGithubUrl()); ?></p>
      </div>
    </div>
  </div>
  <div class="col-lg-4">
